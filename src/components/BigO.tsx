...
function BigO(): JSX.Element {
    ...
    return (
        <div className='BigO'>
            <p>
                Calculate the sum of all numbers from 1 up to some number{' '}
                <i>n</i>
            </p>
            <div>
                <pre>
...
`}
            ...
            <div>
                <ul>
                    ...
                    <li>
                        Accessing elements in array (by index) or object (by
                        key) is constant
                    </li>
                    <li>
                        In a loop, the complexity is the length of the loop
                        times the complexity of whatever happens inside of thr
                        loop
                    </li>
                </ul>
            </div>
            <div>
                ...
                <ul>
                    ...
                    <li>
                        Object.values <b>O(n)</b>
                    </li>
                    <li>
                        Object.entries <b>O(n)</b>
                    </li>
                    <li>
                        hasOwnProperty <b>O(1)</b>
                    </li>
                </ul>
            </div>
            <div>
            ...
            <div>
                ...
                <ul>
                    ...
                    <li>
                        forEach/map/filter/reduce ...<b>O(n)</b>
                    </li>
                </ul>
            </div>
        </div>
